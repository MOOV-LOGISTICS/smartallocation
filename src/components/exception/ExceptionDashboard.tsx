...
export function ExceptionDashboard({ lang, exceptionPOs, openDrawer, onResolve }: ExceptionDashboardProps) {
  const stats = {
  ...
  return (
    <div className="page" style={{ paddingTop: '24px' }}>
      <div className="mb-6">
        ...
        <p className="text-sm mt-1" style={{ color: '#3D6480' }}>Handle pre-assignment exceptions and blocked lots</p>
      </div>
