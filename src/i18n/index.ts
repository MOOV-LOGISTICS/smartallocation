...
export const I18N = {
  en: {
    ...
    stats: { total: 'Total POs', not_started: 'Not Started', assigned: 'AI Auto Assigned', overridden: 'Overridden', on_hold: 'On Hold', exception: 'Exception', trend: { total: 'All imported', not_started: '+4 in last hour', assigned: 'Avg 1.8s per PO', overridden: '{count} of {total} LOTs overridden', on_hold: 'Need supplier action', exception: 'Need human review' } },
    bookingStats: { total: 'Total Requests', not_started: 'Not Started', booked: 'Booked', overridden: 'Overridden', exception: 'Exception', accuracy: 'Pre-assign Accuracy', trend: { total: 'All LOTs with SRD', not_started: 'Awaiting booking run', booked: 'Carrier confirmed', overridden: '{count} of {total} LOTs overridden', exception: 'Action required', accuracy: 'Exact pre-assign match' } },
    ...
    filter: { ALL: 'All', NOT_STARTED: 'Not Started', ASSIGNED: 'Pre-Assigned', MANUALLY_OVERRIDDEN: 'Overridden', ON_HOLD: 'On Hold', EXCEPTION: 'Exception', BOOKED: 'Booked' },
  ...
  zh: {
    ...
    stats: { total: 'PO 总数', not_started: '未启动', assigned: 'AI 自动预排', overridden: '手动覆盖', on_hold: '已暂缓', exception: '异常', trend: { total: '已全部导入', not_started: '过去 1 小时 +4', assigned: '平均 1.8 秒/PO', overridden: '共 {total} 条已排，{count} 条被覆盖', on_hold: '需供应商响应', exception: '需人工介入' } },
    bookingStats: { total: '订舱总数', not_started: '未启动', booked: '已订舱', overridden: '手动覆盖', exception: '异常', accuracy: '预排准确率', trend: { total: '含 SRD 的 LOT 总数', not_started: '待执行订舱', booked: '船司已确认', overridden: '共 {total} 条，{count} 条被覆盖', exception: '需人工介入', accuracy: '预排完全命中' } },
    ...
    filter: { ALL: '全部', NOT_STARTED: '未启动', ASSIGNED: '已预排船', MANUALLY_OVERRIDDEN: '手动覆盖', ON_HOLD: '已暂缓', EXCEPTION: '异常', BOOKED: '已订舱' },
  ...
  de: {
    ...
    stats: { total: 'POs gesamt', not_started: 'Nicht gestartet', assigned: 'KI Auto-Zugewiesen', overridden: 'Überschrieben', on_hold: 'Zurückgestellt', exception: 'Ausnahme', trend: { total: 'Alle importiert', not_started: '+4 in der letzten Stunde', assigned: 'Ø 1,8 s pro PO', overridden: '{count} von {total} LOTs überschrieben', on_hold: 'Lieferant muss handeln', exception: 'Manuelle Prüfung erforderlich' } },
    bookingStats: { total: 'Anfragen gesamt', not_started: 'Nicht gestartet', booked: 'Gebucht', overridden: 'Überschrieben', exception: 'Ausnahme', accuracy: 'Vorab-Buchungsgenauigkeit', trend: { total: 'Alle LOTs mit SRD', not_started: 'Buchung ausstehend', booked: 'Reederei bestätigt', overridden: '{count} von {total} LOTs überschrieben', exception: 'Aktion erforderlich', accuracy: 'Exakte Vorab-Übereinstimmung' } },
    ...
    filter: { ALL: 'Alle', NOT_STARTED: 'Nicht gestartet', ASSIGNED: 'Vorab-zugewiesen', MANUALLY_OVERRIDDEN: 'Überschrieben', ON_HOLD: 'Zurückgestellt', EXCEPTION: 'Ausnahme', BOOKED: 'Gebucht' },
