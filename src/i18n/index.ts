...
export const I18N = {
  en: {
    ...
    stats: { total: 'Total POs', not_started: 'Not Started', assigned: 'AI Auto Assigned', overridden: 'Overridden', on_hold: 'On Hold', exception: 'Exception', needs_action: 'Needs Action', done: 'Completed', trend: { total: 'All imported', not_started: '+4 in last hour', assigned: 'Avg 1.8s per PO', overridden: '{count} of {total} LOTs overridden', on_hold: 'Need supplier action', exception: 'Need human review', needs_action: 'Exception + On Hold', done: 'AI assigned · avg 1.8s per PO' } },
    bookingStats: { total: 'Total Requests', not_started: 'Not Started', booked: 'Booked', overridden: 'Overridden', exception: 'Exception', needs_action: 'Needs Action', accuracy: 'Pre-assign Accuracy', trend: { total: 'All LOTs with SRD', not_started: 'Awaiting booking run', booked: 'Carrier confirmed', overridden: '{count} of {total} LOTs overridden', exception: 'Action required', needs_action: 'Exception + On Hold', accuracy: 'Exact pre-assign match' } },
    bookingStatus: { ASSIGNED: 'Booked', NOT_STARTED: 'Not Started', ON_HOLD: 'On Hold', EXCEPTION: 'Exception', RUNNING: 'Running…', BOOKED_EXACT: 'Booked · Exact Match', BOOKED_UPDATED: 'Booked · Updated', MANUALLY_OVERRIDDEN: 'Booked · Manual Override' },
    search: { placeholder: 'Search PO, Lot, IAN, POL, POD…' },
    filter: { ALL: 'All', NOT_STARTED: 'Not Started', ASSIGNED: 'Pre-Assigned', MANUALLY_OVERRIDDEN: 'Overridden', ON_HOLD: 'On Hold', EXCEPTION: 'Exception', BOOKED: 'Booked', NEEDS_ACTION: 'Needs Action', DONE: 'Completed' },
    excFilter: { label: 'Issue Type:', ALL: 'All Reasons', SCHEDULE: 'Schedule Risk', NO_VESSEL: 'No Vessel Match', NO_SPACE: 'No Space', SUPPLIER: 'Awaiting Supplier', RESOLVED: 'Resolved · Pending Re-run' },
    filterPanel: { button: 'Filters', title: 'Filter by attribute', carrier: 'Carrier', pol: 'POL', pod: 'POD', vessel: 'Vessel', supplier: 'Supplier', teu: 'TEU', teuMin: 'Min', teuMax: 'Max', clearAll: 'Clear all', saveViewPlaceholder: 'Name this view…', saveView: 'Save', deleteView: 'Delete view', search: 'Search…' },
    views: { saved: '⭐ View "{name}" saved', allLots: 'All LOTs', saveHint: 'Save current filters as a view', saveDisabledHint: 'Set some filters first, then save them as a view' },
    btn: { syncFromBi: 'Sync from BI', runAll: 'Run All Not-Started', runSelected: 'Run Pre-Assign · {n} POs', running: 'Running…', runSingle: 'Run', review: 'Review', trace: 'Trace', close: 'Close', rerun: 'Re-run', gotoException: '→ Go to Exception Handling', resolve: 'Resolve', sendToSmartMoov: 'Send to SmartMOOV', sendToSmartMoovN: 'Send to SmartMOOV · {n} LOTs', resolveSelected: 'Resolve · {n} LOTs', rerunSelected: 'Re-run · {n} LOTs' },
    ...
    batchResolve: { title: 'Resolve Exceptions', summary: 'Resolving {n} LOTs. They will be marked ready to re-run.' },
    ...
    table: {
      ...
      status: 'Status', empty: 'No POs match the current filter.', sentToSmartMoov: 'Sent to SmartMOOV',
      ianSupplier: 'IAN {ian} · {supplier}', noCarrier: '—'
    },
    status: { ASSIGNED: 'Pre-Assigned', NOT_STARTED: 'Not Started', ON_HOLD: 'On Hold', EXCEPTION: 'Exception', RESOLVED_PENDING_RERUN: 'Resolved', RUNNING: 'Running…', MANUALLY_OVERRIDDEN: 'Overridden' },
  ...
  zh: {
    ...
    stats: { total: 'PO 总数', not_started: '未启动', assigned: 'AI 自动预排', overridden: '手动覆盖', on_hold: '已暂缓', exception: '异常', needs_action: '需要处理', done: '已完成', trend: { total: '已全部导入', not_started: '过去 1 小时 +4', assigned: '平均 1.8 秒/PO', overridden: '共 {total} 条已排，{count} 条被覆盖', on_hold: '需供应商响应', exception: '需人工介入', needs_action: '异常 + 已暂缓', done: 'AI 已预排 · 平均 1.8 秒/PO' } },
    bookingStats: { total: '订舱总数', not_started: '未启动', booked: '已订舱', overridden: '手动覆盖', exception: '异常', needs_action: '需要处理', accuracy: '预排准确率', trend: { total: '含 SRD 的 LOT 总数', not_started: '待执行订舱', booked: '船司已确认', overridden: '共 {total} 条，{count} 条被覆盖', exception: '需人工介入', needs_action: '异常 + 已暂缓', accuracy: '预排完全命中' } },
    bookingStatus: { ASSIGNED: '已订舱', NOT_STARTED: '未启动', ON_HOLD: '已暂缓', EXCEPTION: '异常', RUNNING: '执行中…', BOOKED_EXACT: '已订舱 · 完全命中', BOOKED_UPDATED: '已订舱 · 已更新', MANUALLY_OVERRIDDEN: '已订舱 · 手动覆盖' },
    search: { placeholder: '搜索 PO、Lot、IAN、POL、POD…' },
    filter: { ALL: '全部', NOT_STARTED: '未启动', ASSIGNED: '已预排船', MANUALLY_OVERRIDDEN: '手动覆盖', ON_HOLD: '已暂缓', EXCEPTION: '异常', BOOKED: '已订舱', NEEDS_ACTION: '需要处理', DONE: '已完成' },
    excFilter: { label: '问题类型：', ALL: '全部原因', SCHEDULE: '排期风险', NO_VESSEL: '无匹配船期', NO_SPACE: '无舱位', SUPPLIER: '等待供应商', RESOLVED: '已解决 · 待重跑' },
    filterPanel: { button: '筛选', title: '按属性筛选', carrier: '船公司', pol: '起运港', pod: '目的港', vessel: '船舶', supplier: '供应商', teu: 'TEU', teuMin: '最小值', teuMax: '最大值', clearAll: '清除全部', saveViewPlaceholder: '给这个视图起个名字…', saveView: '保存', deleteView: '删除视图', search: '搜索…' },
    views: { saved: '⭐ 视图“{name}”已保存', allLots: '全部 LOT', saveHint: '将当前筛选保存为视图', saveDisabledHint: '先设置筛选条件，再保存为视图' },
    btn: { syncFromBi: '从 BI 同步', runAll: '执行所有未启动', runSelected: '执行预排船 · {n} 条', running: '执行中…', runSingle: '执行', review: '审核', trace: '查看日志', close: '关闭', rerun: '重新执行', gotoException: '→ 转至异常处理', resolve: '解决', sendToSmartMoov: '发送至 SmartMOOV', sendToSmartMoovN: '发送至 SmartMOOV · {n} 条', resolveSelected: '解决 · {n} 条', rerunSelected: '重新执行 · {n} 条' },
    ...
    batchResolve: { title: '批量解决异常', summary: '正在解决 {n} 条 LOT，将标记为待重新执行。' },
    selection: '已选 {n} 条',
    table: {
      ...
      status: '状态', empty: '无符合当前筛选条件的 PO。', sentToSmartMoov: '已发送至 SmartMOOV',
      ianSupplier: 'IAN {ian} · {supplier}', noCarrier: '—'
    },
    status: { ASSIGNED: '已预排船', NOT_STARTED: '未启动', ON_HOLD: '已暂缓', EXCEPTION: '异常', RESOLVED_PENDING_RERUN: '已解决', RUNNING: '执行中…', MANUALLY_OVERRIDDEN: '手动覆盖' },
  ...
  de: {
    ...
    stats: { total: 'POs gesamt', not_started: 'Nicht gestartet', assigned: 'KI Auto-Zugewiesen', overridden: 'Überschrieben', on_hold: 'Zurückgestellt', exception: 'Ausnahme', needs_action: 'Handlungsbedarf', done: 'Abgeschlossen', trend: { total: 'Alle importiert', not_started: '+4 in der letzten Stunde', assigned: 'Ø 1,8 s pro PO', overridden: '{count} von {total} LOTs überschrieben', on_hold: 'Lieferant muss handeln', exception: 'Manuelle Prüfung erforderlich', needs_action: 'Ausnahme + Zurückgestellt', done: 'KI zugewiesen · Ø 1,8 s pro PO' } },
    bookingStats: { total: 'Anfragen gesamt', not_started: 'Nicht gestartet', booked: 'Gebucht', overridden: 'Überschrieben', exception: 'Ausnahme', needs_action: 'Handlungsbedarf', accuracy: 'Vorab-Buchungsgenauigkeit', trend: { total: 'Alle LOTs mit SRD', not_started: 'Buchung ausstehend', booked: 'Reederei bestätigt', overridden: '{count} von {total} LOTs überschrieben', exception: 'Aktion erforderlich', needs_action: 'Ausnahme + Zurückgestellt', accuracy: 'Exakte Vorab-Übereinstimmung' } },
    bookingStatus: { ASSIGNED: 'Gebucht', NOT_STARTED: 'Nicht gestartet', ON_HOLD: 'Zurückgestellt', EXCEPTION: 'Ausnahme', RUNNING: 'Läuft…', BOOKED_EXACT: 'Gebucht · Exakte Übereinstimmung', BOOKED_UPDATED: 'Gebucht · Aktualisiert', MANUALLY_OVERRIDDEN: 'Gebucht · Manuell' },
    search: { placeholder: 'PO, Lot, IAN, POL, POD suchen…' },
    filter: { ALL: 'Alle', NOT_STARTED: 'Nicht gestartet', ASSIGNED: 'Vorab-zugewiesen', MANUALLY_OVERRIDDEN: 'Überschrieben', ON_HOLD: 'Zurückgestellt', EXCEPTION: 'Ausnahme', BOOKED: 'Gebucht', NEEDS_ACTION: 'Handlungsbedarf', DONE: 'Abgeschlossen' },
    excFilter: { label: 'Problemtyp:', ALL: 'Alle Gründe', SCHEDULE: 'Terminrisiko', NO_VESSEL: 'Keine Schiffszuordnung', NO_SPACE: 'Kein Platz', SUPPLIER: 'Wartet auf Lieferant', RESOLVED: 'Gelöst · Wartet auf Re-Run' },
    filterPanel: { button: 'Filter', title: 'Nach Attribut filtern', carrier: 'Reederei', pol: 'POL', pod: 'POD', vessel: 'Schiff', supplier: 'Lieferant', teu: 'TEU', teuMin: 'Min', teuMax: 'Max', clearAll: 'Alle löschen', saveViewPlaceholder: 'Ansicht benennen…', saveView: 'Speichern', deleteView: 'Ansicht löschen', search: 'Suchen…' },
    views: { saved: '⭐ Ansicht "{name}" gespeichert', allLots: 'Alle LOTs', saveHint: 'Aktuelle Filter als Ansicht speichern', saveDisabledHint: 'Erst Filter setzen, dann als Ansicht speichern' },
    btn: { syncFromBi: 'Aus BI synchronisieren', runAll: 'Alle nicht gestarteten ausführen', runSelected: 'Vorab-Buchung ausführen · {n} POs', running: 'Läuft…', runSingle: 'Ausführen', review: 'Prüfen', trace: 'Trace', close: 'Schließen', rerun: 'Erneut ausführen', gotoException: '→ Zur Ausnahmebehandlung', resolve: 'Lösen', sendToSmartMoov: 'An SmartMOOV senden', sendToSmartMoovN: 'An SmartMOOV senden · {n} LOTs', resolveSelected: 'Lösen · {n} LOTs', rerunSelected: 'Erneut ausführen · {n} LOTs' },
    ...
    batchResolve: { title: 'Ausnahmen lösen', summary: '{n} LOTs werden gelöst und für den Re-Run markiert.' },
    ...
    table: {
      ...
      status: 'Status', empty: 'Keine POs entsprechen dem aktuellen Filter.', sentToSmartMoov: 'An SmartMOOV gesendet',
      ianSupplier: 'IAN {ian} · {supplier}', noCarrier: '—'
    },
    status: { ASSIGNED: 'Vorab-zugewiesen', NOT_STARTED: 'Nicht gestartet', ON_HOLD: 'Zurückgestellt', EXCEPTION: 'Ausnahme', RESOLVED_PENDING_RERUN: 'Gelöst', RUNNING: 'Läuft…', MANUALLY_OVERRIDDEN: 'Überschrieben' },
