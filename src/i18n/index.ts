...
export const I18N = {
  en: {
    ...
    btn: { syncFromBi: 'Sync from BI', runAll: 'Run All Not-Started', runSelected: 'Run Pre-Assign · {n} POs', running: 'Running…', runSingle: 'Run', review: 'Review', trace: 'Trace', close: 'Close', rerun: 'Re-run', gotoException: '→ Go to Exception Handling', resolve: 'Resolve', sendToSmartMoov: 'Send to SmartMOOV', sendToSmartMoovN: 'Send to SmartMOOV · {n} LOTs', resolveSelected: 'Resolve · {n} LOTs', rerunSelected: 'Re-run · {n} LOTs', reschedule: 'Reschedule', rescheduleN: 'Reschedule · {n} LOTs' },
    reschedule: {
      title: 'Reschedule {n} LOTs · {lane}',
      titleGeneric: 'Reschedule Carrier',
      multiLaneHint: 'Your selection spans {n} lanes. Vessels are lane-specific, so reschedule one lane at a time — pick the lane to process now:',
      laneCount: '{n} LOTs selected',
      carrierLabel: 'Target carrier',
      carrierPlaceholder: 'Select a carrier…',
      carrierHint: 'Carriers serving this lane, from the Booking Matrix.',
      voyageLabel: 'Vessel / Voyage',
      voyagePlaceholder: 'Select a voyage…',
      pickCarrierFirst: 'Select a carrier first',
      noVoyages: 'No scheduled voyages for this carrier on this lane',
      etaTooLate: 'ETA exceeds every selected LDD',
      voyageHint: 'Scheduled voyages for the selected carrier on this lane. ETD/ETA and service are applied automatically.',
      previewLabel: 'Review changes — uncheck any LOT to exclude it',
      allocOk: '✓ {carrier} allocation W{week}: {remaining} TEU remaining, this reschedule adds {adding} TEU.',
      allocOvercommit: '⚠ {carrier} allocation W{week}: only {remaining} TEU remaining, adding {adding} TEU brings utilization to {pct}%. Overcommit is allowed at pre-assign stage.',
      confirmBtn: 'Confirm Reschedule · {n} LOTs',
      toast: '✅ {n} LOTs rescheduled to {carrier} · {vessel}',
    },
  ...
  zh: {
    ...
    btn: { syncFromBi: '从 BI 同步', runAll: '执行所有未启动', runSelected: '执行预排船 · {n} 条', running: '执行中…', runSingle: '执行', review: '审核', trace: '查看日志', close: '关闭', rerun: '重新执行', gotoException: '→ 转至异常处理', resolve: '解决', sendToSmartMoov: '发送至 SmartMOOV', sendToSmartMoovN: '发送至 SmartMOOV · {n} 条', resolveSelected: '解决 · {n} 条', rerunSelected: '重新执行 · {n} 条', reschedule: '改配船司', rescheduleN: '改配船司 · {n} 条' },
    reschedule: {
      title: '改配 {n} 条 LOT · {lane}',
      titleGeneric: '改配船司',
      multiLaneHint: '所选 LOT 涉及 {n} 条航线。船期与航线绑定，请一次处理一条航线——选择本次要处理的航线：',
      laneCount: '已选 {n} 条',
      carrierLabel: '目标船司',
      carrierPlaceholder: '选择船司…',
      carrierHint: '选项来自 Booking Matrix 中服务该航线的船司。',
      voyageLabel: '船舶 / 航次',
      voyagePlaceholder: '选择航次…',
      pickCarrierFirst: '请先选择船司',
      noVoyages: '该船司在此航线上暂无排班',
      etaTooLate: 'ETA 晚于所有已选 LOT 的 LDD',
      voyageHint: '该船司在此航线上的排班。ETD/ETA 与 service 自动带出。',
      previewLabel: '确认变更——取消勾选可排除个别 LOT',
      allocOk: '✓ {carrier} 配额 W{week}：剩余 {remaining} TEU，本次改配占用 {adding} TEU。',
      allocOvercommit: '⚠ {carrier} 配额 W{week}：仅剩 {remaining} TEU，加入 {adding} TEU 后利用率将达 {pct}%。预排阶段允许超定。',
      confirmBtn: '确认改配 · {n} 条',
      toast: '✅ {n} 条 LOT 已改配至 {carrier} · {vessel}',
    },
  ...
  de: {
    ...
    btn: { syncFromBi: 'Aus BI synchronisieren', runAll: 'Alle nicht gestarteten ausführen', runSelected: 'Vorab-Buchung ausführen · {n} POs', running: 'Läuft…', runSingle: 'Ausführen', review: 'Prüfen', trace: 'Trace', close: 'Schließen', rerun: 'Erneut ausführen', gotoException: '→ Zur Ausnahmebehandlung', resolve: 'Lösen', sendToSmartMoov: 'An SmartMOOV senden', sendToSmartMoovN: 'An SmartMOOV senden · {n} LOTs', resolveSelected: 'Lösen · {n} LOTs', rerunSelected: 'Erneut ausführen · {n} LOTs', reschedule: 'Umbuchen', rescheduleN: 'Umbuchen · {n} LOTs' },
    reschedule: {
      title: '{n} LOTs umbuchen · {lane}',
      titleGeneric: 'Reederei umbuchen',
      multiLaneHint: 'Die Auswahl umfasst {n} Routen. Schiffe sind routenspezifisch — bitte eine Route nach der anderen bearbeiten. Route auswählen:',
      laneCount: '{n} LOTs ausgewählt',
      carrierLabel: 'Ziel-Reederei',
      carrierPlaceholder: 'Reederei wählen…',
      carrierHint: 'Reedereien auf dieser Route laut Booking Matrix.',
      voyageLabel: 'Schiff / Reise',
      voyagePlaceholder: 'Reise wählen…',
      pickCarrierFirst: 'Zuerst Reederei wählen',
      noVoyages: 'Keine geplanten Abfahrten dieser Reederei auf dieser Route',
      etaTooLate: 'ETA überschreitet alle gewählten LDDs',
      voyageHint: 'Geplante Abfahrten der gewählten Reederei auf dieser Route. ETD/ETA und Service werden automatisch übernommen.',
      previewLabel: 'Änderungen prüfen — LOTs abwählen, um sie auszuschließen',
      allocOk: '✓ {carrier}-Kontingent W{week}: {remaining} TEU verfügbar, diese Umbuchung belegt {adding} TEU.',
      allocOvercommit: '⚠ {carrier}-Kontingent W{week}: nur {remaining} TEU verfügbar, +{adding} TEU ergibt {pct}% Auslastung. Überbuchung ist in der Vorab-Phase erlaubt.',
      confirmBtn: 'Umbuchen bestätigen · {n} LOTs',
      toast: '✅ {n} LOTs umgebucht auf {carrier} · {vessel}',
    },
