...
export const I18N = {
  en: {
    ...
    excFilter: { label: 'Reason:', ALL: 'All Reasons', SCHEDULE: 'Schedule Risk', NO_VESSEL: 'No Vessel Match', NO_SPACE: 'No Space', SUPPLIER: 'Awaiting Supplier', RESOLVED: 'Resolved · Pending Re-run' },
  ...
  zh: {
    ...
    excFilter: { label: '原因：', ALL: '全部原因', SCHEDULE: '排期风险', NO_VESSEL: '无匹配船期', NO_SPACE: '无舱位', SUPPLIER: '等待供应商', RESOLVED: '已解决 · 待重跑' },
  ...
  de: {
    ...
    excFilter: { label: 'Grund:', ALL: 'Alle Gründe', SCHEDULE: 'Terminrisiko', NO_VESSEL: 'Keine Schiffszuordnung', NO_SPACE: 'Kein Platz', SUPPLIER: 'Wartet auf Lieferant', RESOLVED: 'Gelöst · Wartet auf Re-Run' },
