...
export const I18N = {
  en: {
    ...
    filterPanel: { button: 'Filters', title: 'Filter by attribute', carrier: 'Carrier', pol: 'POL', pod: 'POD', vessel: 'Vessel', supplier: 'Supplier', teu: 'TEU range', teuMin: 'Min', teuMax: 'Max', clearAll: 'Clear all', saveViewPlaceholder: 'Name this view…', saveView: 'Save as View', deleteView: 'Delete view' },
  ...
  zh: {
    ...
    filterPanel: { button: '筛选', title: '按属性筛选', carrier: '船公司', pol: '起运港', pod: '目的港', vessel: '船舶', supplier: '供应商', teu: 'TEU 范围', teuMin: '最小值', teuMax: '最大值', clearAll: '清除全部', saveViewPlaceholder: '给这个视图起个名字…', saveView: '保存为视图', deleteView: '删除视图' },
    views: { saved: '⭐ 视图“{name}”已保存' },
  ...
  de: {
    ...
    filterPanel: { button: 'Filter', title: 'Nach Attribut filtern', carrier: 'Reederei', pol: 'POL', pod: 'POD', vessel: 'Schiff', supplier: 'Lieferant', teu: 'TEU-Bereich', teuMin: 'Min', teuMax: 'Max', clearAll: 'Alle löschen', saveViewPlaceholder: 'Ansicht benennen…', saveView: 'Als Ansicht speichern', deleteView: 'Ansicht löschen' },
